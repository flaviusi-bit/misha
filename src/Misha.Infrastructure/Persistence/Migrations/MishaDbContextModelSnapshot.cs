...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Misha.Domain.Etas.EtaAudit", b =>
        {
            ...
            b.Property<string>("EventType").IsRequired().HasMaxLength(32).HasColumnType("character varying(32)");
        ...
        modelBuilder.Entity("Misha.Domain.ManualReviews.ManualReviewCase", b =>
        {
            ...
            b.Property<string>("Resolution").HasMaxLength(32).HasColumnType("character varying(32)");
        ...
        modelBuilder.Entity("Misha.Domain.ManualReviews.ManualReviewCase", b =>
        {
            b.HasOne("Misha.Domain.Applications.Application", null)
                .WithMany()
        ...
        modelBuilder.Entity("Misha.Domain.Etas.EtaAudit", b =>
        {
            b.HasOne("Misha.Domain.Etas.Eta", null)
                .WithMany()
                .HasForeignKey("EtaId");
            b.HasOne("Misha.Domain.Applications.Application", null)
                .WithMany()
