...
public partial class AddApplicationLifecycleAudits : Migration
{
    ...
    {
        migrationBuilder.CreateTable(name: "application_lifecycle_audits", columns: table => new
        {
        ...
        migrationBuilder.CreateIndex(name: "IX_application_lifecycle_audits_ApplicationId_OccurredAtUtc", table: "application_lifecycle_audits", columns: new[] { "ApplicationId", "OccurredAtUtc" });
    }

    protected override void Down(MigrationBuilder migrationBuilder) => migrationBuilder.DropTable(name: "application_lifecycle_audits");
}
