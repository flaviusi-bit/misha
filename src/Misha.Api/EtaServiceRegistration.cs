...
public static class EtaServiceRegistration
{
    ...
    {
        app.MapPost("/applications/{id:guid}/eta", async (Guid id, EtaService service, CancellationToken ct) =>
        {
            try
            {
        ...
        app.MapPost("/eta/verify", async (EtaVerificationRequest request, EtaService service, CancellationToken ct) =>
        {
