...
{
    private readonly IRiskAssessmentEngine riskAssessmentEngine = riskAssessmentEngine ?? new DeterministicRiskAssessmentEngine();
        ...
        CancellationToken cancellationToken)
    {
        ...
        return riskAssessmentEngine.Assess(policyEvaluation);
    }
}
